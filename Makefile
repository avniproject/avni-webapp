...
start_server_staging: build_server
	...
	OPENCHS_BUCKET_NAME=staging-user-media OPENCHS_DATABASE_URL=jdbc:postgresql://localhost:6015/openchs java -jar avni-server-api/build/libs/avni-server-0.0.1-SNAPSHOT.jar
