...
function NewsList() {
  ...
  const [sorting, setSorting] = useState([
    { id: "lastModifiedDateTime", desc: true }
  ]);
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        header: "Modified On",
        Cell: ({ row }) =>
          getFormattedDateTime(row.original.lastModifiedDateTime)
      },
      {
        accessorKey: "publishedDate",
        header: "Published On",
        Cell: ({ row }) =>
          isNil(row.original.publishedDate)
            ? "-"
            : getFormattedDateTime(row.original.publishedDate)
      },
      {
        id: "action",
        header: "Action",
        ...
        Cell: ({ row }) => (
          <a href={`#/broadcast/news/${row.original.id}/details`}>
            See details
          </a>
        )
      }
