...
const BroadcastPage = function({ path, organisationConfig, userInfo }) {
  const showMessaging = UserInfo.hasPrivilege(
    userInfo,
        ...
        {organisationConfig &&
          ...
          showMessaging && (
            <HomePageCard
              ...
              name="WhatsApp"
              customIconComponent={
                <WhatsApp color="primary" style={{ fontSize: 100 }} />
              }
            />
          )}
      </Grid>
...
const Broadcast = () => {
  ...
  return (
    <Routes>
      ...
      />
      <Route
        path={`${BroadcastPath.WhatsApp}/${
          BroadcastPath.ContactGroup
        }/:contactGroupId`}
        element={<WhatsAppContactGroup />}
      />
      <Route
        path={`${BroadcastPath.WhatsApp}/:activeTab/:receiverId/messages`}
        element={<WhatsAppHome />}
      />
    </Routes>
  );
