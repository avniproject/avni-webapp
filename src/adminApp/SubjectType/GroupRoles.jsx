...
export default function GroupRoles({
  ...
  const [subjectTypeOptions, setSubjectTypes] = useState();
  ...
  const filterOptions = option =>
    (Types.isHousehold(type) &&
      includes(Types.householdMemberTypes, option.type)) ||
    (Types.getType("Group") === type &&
      includes(Types.groupMemberTypes, option.type));
  ...
  return (
    <StyledContainer>
        ...
        <StyledGrid key={index} container direction="row">
          <StyledInputContainer noValidate autoComplete="off">
            <TextField
              ...
              onChange={event =>
                onGroupRoleChange(
                  { ...groupRole, role: event.target.value },
                  index
                )
              }
            />
            ...
            <TextField
              ...
              variant="outlined"
              value={
                groupRole.minimumNumberOfMembers === ""
                  ? ""
                  : groupRole.minimumNumberOfMembers
              }
              onChange={event =>
                onGroupRoleChange(
                  {
                    ...groupRole,
                    minimumNumberOfMembers: +event.target.value.replace(
                      /\D/g,
                      ""
                    )
                  },
            ...
            <TextField
              ...
              variant="outlined"
              value={
                groupRole.maximumNumberOfMembers === ""
                  ? ""
                  : groupRole.maximumNumberOfMembers
              }
              onChange={event =>
                onGroupRoleChange(
                  {
                    ...groupRole,
                    maximumNumberOfMembers: +event.target.value.replace(
                      /\D/g,
                      ""
                    )
                  },
      ...
      {error && (
        <FormHelperText error>Group fields can not be blank</FormHelperText>
      )}
      {!Types.isHousehold(type) && (
        <StyledAddButton
          type="button"
