      ...
      <CustomAccordionDetails>
        <StyledSettingsContainer>
          ...
          <ValidFormat
            ...
            dispatch={dispatch}
            regexLabel={
              subjectType.type === "Person" ? "First Name Regex" : "Name Regex"
            }
              ...
              {subjectType.allowMiddleName && (
                <>
                  <ValidFormat
                    ...
                    regexToolTipKey={
                      "APP_DESIGNER_SUBJECT_TYPE_MIDDLE_NAME_REGEX"
                    }
          ...
          <AvniFormLabel
            ...
            toolTipKey={"APP_DESIGNER_NAME_HELP_TEXT"}
          />
          <StyledInput
            multiline
            id={"nameHelpText"}
          ...
          {!isEmpty(subjectType.settings) && (
            <div>
              <AvniSwitch
                ...
                toolTipKey={
                  "APP_DESIGNER_SUBJECT_TYPE_DISPLAY_REGISTRATION_DETAILS"
                }
              />
              <AvniSwitch
            ...
            {subjectType.type === SubjectTypeType.User ? (
              ...
              <>
                ...
                <AvniSwitch
                  ...
                  toolTipKey={
                    "APP_DESIGNER_SUBJECT_TYPE_SYNC_BY_DIRECT_ASSIGNMENT"
                  }
                />
                <OptionSelect
