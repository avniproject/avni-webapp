...
export const DeleteData = ({
  ...
  const deleteAdminConfigurationMessage =
    "Delete all admin configurations except Administrators";
  ...
  const deleteData = () => {
    ...
    http
      .delete(
        `/implementation/delete?deleteMetadata=${deleteMetadata}&deleteAdminConfig=${deleteAdminConfig}`
      )
      .then(res => {
        if (res.status === 200) {
          ...
          setMessage({
            ...
            content: deleteClientDataMessage
          });
          setShowAlert(true);
        }
      })
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={event =>
                      setDeleteAdminConfig(event.target.checked)
                    }
