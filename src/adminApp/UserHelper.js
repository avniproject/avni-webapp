...
import { email, minLength, regex, required, SaveButton, TextInput, Toolbar } from "react-admin";
...
export const UserFilter = [
  ...
  <TextInput label="Name" source="name" alwaysOn autoComplete="off" resettable />,
