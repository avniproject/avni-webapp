...
const ApplicationMenuShow = () => {
  ...
  useEffect(() => {
    ApplicationMenuService.getMenuItem(id).then(menuItem => setApplicationMenu(menuItem));
  }, [id]);
    ...
    !_.isNil(menuItem) && (
      <>
        ...
        >
          ...
          {UserInfo.hasPrivilege(userInfo, Privilege.PrivilegeType.EditApplicationMenu) && (
