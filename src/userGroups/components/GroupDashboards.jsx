...
function addDashboardToGroupHandler(
  ...
  api
    .addDashboardsToGroup(
      dashboardsToBeAdded.map(dashboard => ({
...
const GroupDashboards = ({ groupId, ...props }) => {
  ...
  const groupDashboards = useSelector(
    state => state.userGroups.groupDashboards
  );
      ...
      },
      {
        ...
        Cell: ({ row }) => (
          <Checkbox
            ...
            onChange={e =>
              setDashboardType(
                { ...row.original, primaryDashboard: e.target.checked },
                () => dispatch(getGroupDashboards(groupId))
              )
            }
          />
      ...
      },
      {
        ...
        Cell: ({ row }) => (
          <Checkbox
            ...
            onChange={e =>
              setDashboardType(
                { ...row.original, secondaryDashboard: e.target.checked },
                () => dispatch(getGroupDashboards(groupId))
              )
            }
          />
      ...
      },
      {
        ...
        Cell: ({ row }) => (
          <IconButton
            ...
            onClick={() =>
              removeDashboardFromGroupHandler(row.original, groupId, () =>
                dispatch(getGroupDashboards(groupId))
              )
            }
          >
