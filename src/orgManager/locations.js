...
const ParentLocationReferenceField = props => {
    return isNil(props.record.parentId) ?
        <None/>
        :
        <ReferenceField {...props} label="Parent location"
                        source="parentId"
                        linkType="show"
                        reference="locations"
                        allowEmpty>
                        ...
                        <FormDataConsumer>
                            {({ formData, dispatch, ...rest }) =>
                                <ReferenceInput label="Type"
                                                ...
                                                {...rest}>
                                    <LocationTypeSelectInput optionText="name"
                                                             resettable/>
                                </ReferenceInput>
                            }
                        </FormDataConsumer>
                    ...
                    edit ?
                        ...
                        <FormDataConsumer>
                            {({ formData, dispatch, ...rest }) =>
                                ...
                                <ReferenceInput label="Part of (location)"
