...
const UploadDashboard = () => {
  ...
  const handleUploadFile = useCallback(async () => {
    try {
      const locationUploadModeValue =
        uploadType === UPLOAD_TYPES.LOCATIONS ? locationUploadMode : "";
              ...
              <Grid container>
                <StyledFormStack>
                  <DropDown
                    ...
                    options={uploadAndDownloadOptions}
                  />
                  <Tooltip
                    title="Download Sample file for selected Upload type"
                  ...
                  >
                    <span>
                      <Button
                        ...
                        disabled={isSampleDownloadDisallowed}
                      >
                ...
                {isMetadataDiffReviewEnabled &&
                  uploadType ===
                    staticTypesWithStaticDownload.getName("metadataZip") &&
                  file && (
                    <Grid>
              ...
              <Grid container>
                {uploadType === UPLOAD_TYPES.LOCATIONS && (
                  <LocationModes
                    ...
                    setMode={setLocationUploadMode}
                  />
                )}
                {isEncounterType(uploadType) && (
                  <EncounterModes
