        ...
        {visitSchedules.map(row => (
          <TableRow key={row.name}>
            ...
            <TableCell align="left">
              {row.earliestDate && isValid(new Date(row.earliestDate))
                ? format(new Date(row.earliestDate), "dd-MM-yyyy")
                : "-"}
            </TableCell>
            <TableCell align="left">
              {row.maxDate && isValid(new Date(row.maxDate))
                ? format(new Date(row.maxDate), "dd-MM-yyyy")
                : "-"}
            </TableCell>
          </TableRow>
        ))}
