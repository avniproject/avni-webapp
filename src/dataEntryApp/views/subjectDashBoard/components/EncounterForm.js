...
const EncounterForm = () => {
  ...
  const observations = useSelector(state => state.dataEntry.encounterReducer.encounter.observations);
  const obsHolder = useSelector(state => new ObservationsHolder(state.dataEntry.encounterReducer.encounter.observations));
  ...
  const entity = useSelector(state => state.dataEntry.encounterReducer.encounter);
