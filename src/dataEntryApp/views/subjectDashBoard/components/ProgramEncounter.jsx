...
const ProgramEncounter = () => {
  ...
  const programEncounterForm = useSelector(
  ...
  const editProgramEncounterFlow = isEqual(
    path,
    "/app/subject/editProgramEncounter"
  );

  const handleEditProgramEncounter = (...args) =>
    dispatch(editProgramEncounter(...args));
  const handleResetState = () => dispatch(resetState());
  const handleCreateProgramEncounter = (...args) =>
    dispatch(createProgramEncounter(...args));
  const handleCreateProgramEncounterForScheduled = (...args) =>
    dispatch(createProgramEncounterForScheduled(...args));
  const handleSetEncounterDate = (...args) =>
    dispatch(setEncounterDate(...args));
