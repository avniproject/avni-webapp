...
export default {
  ...
  saveRelationShip: (Relationaldata) => httpClient.post("/individualRelationships", Relationaldata),
  ...
  getSubjectSummary: (subjectUUID) =>
    httpClient.get(`/web/subjectSummaryRule?subjectUUID=${subjectUUID}`).then((response) => response.data),
