...
public interface ConceptRepository extends PagingAndSortingRepository<Concept, Long> {
    ...
    Page<Concept> findByLastModifiedDateTimeGreaterThan(@Param("lastModifiedDateTime") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) DateTime lastModifiedDateTime, Pageable pageable);
}