    ...
    >
      ...
      >
        <TutorialCard
          ...
          href={
            "https://avni.readme.io/docs/implementers-concept-guide-introduction"
          }
          iconComponent={
            <Description
              color="primary"
              style={{ fontSize: 60, color: "#009688" }}
            />
          }
        />
      </Grid>
      ...
      >
        <TutorialCard
          ...
          iconComponent={
            <VideoLibrary
              color="primary"
              style={{ fontSize: 60, color: "#d50000" }}
            />
          }
        />
      </Grid>
      ...
      >
        <TutorialCard
          ...
          href={
            "https://calendly.com/openchssupport-customersuccess/support-session"
          }
          footer={sessionFooter}
          iconComponent={
            <Event color="primary" style={{ fontSize: 60, color: "#40c4ff" }} />
          }
        />
      </Grid>
      <Grid
      ...
      >
        <TutorialCard
          ...
          iconComponent={
            <ConfirmationNumber
              color="primary"
              style={{ fontSize: 60, color: "#66bb6a" }}
            />
          }
        />
      </Grid>
