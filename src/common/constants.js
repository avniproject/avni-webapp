...
export const cognitoInDev =
  isDevEnv && process.env.REACT_APP_COGNITO_IN_DEV === "true";
...
export const phoneCountryPrefix =
  process.env.REACT_APP_PHONE_COUNTRY_PREFIX || "+91";
