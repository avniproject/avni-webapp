...
export const formDesignerOnSaveInlineConcept = (
  ...
  const inlineConceptObject = {
    ...
    lowAbsolute:
      clonedFormElement["inlineNumericDataTypeAttributes"].lowAbsolute,
    highAbsolute:
      clonedFormElement["inlineNumericDataTypeAttributes"].highAbsolute,
  ...
  if (inlineConceptObject.dataType === "Location") {
    if (
      clonedFormElement["inlineLocationDataTypeKeyValues"]
        .lowestAddressLevelTypeUUIDs.length === 0
    ) {
  ...
  if (inlineConceptObject.dataType === "Numeric") {
    if (
      ...
      parseInt(inlineConceptObject.lowAbsolute) >
      parseInt(inlineConceptObject.highAbsolute)
    ) {
    ...
    if (
      ...
      parseInt(inlineConceptObject.lowNormal) >
      parseInt(inlineConceptObject.highNormal)
    ) {
  ...
  if (
    ...
    if (inlineConceptObject.dataType === "Coded") {
      ...
      if (
        ...
        clonedFormElement.inlineConceptErrorMessage["inlineConceptError"] =
          "One or more invalid answer values specified for Coded Concept";
      }
