...
function InlineConcept(props) {
  ...
  const renderInlinePhoneNumber = () => {
    ...
    return (
      <PhoneNumberConcept
        ...
        checked={
          props.formElementData.inlinePhoneNumberDataTypeKeyValues
            .verifyPhoneNumber
        }
      />
    );
  ...
  return (
    <>
      ...
      {props.formElementData.inlineConceptDataType === "Numeric" && (
        <NumericConcept
          onNumericConceptAttributeAssignment={
            props.handleInlineNumericAttributes
          }
          numericDataTypeAttributes={
            props.formElementData.inlineNumericDataTypeAttributes
          }
          inlineConcept={true}
      ...
      {props.formElementData.inlineConceptDataType === "Coded" && (
        ...
        >
          <Button
            ...
            color="primary"
            onClick={() =>
              props.onAlphabeticalSort(props.groupIndex, props.index)
            }
          >
            Sort alphabetically
          </Button>
      ...
      {props.formElementData.inlineConceptDataType === "PhoneNumber" &&
        renderInlinePhoneNumber()}
      <Button
        variant="contained"
        color="primary"
        margin="normal"
