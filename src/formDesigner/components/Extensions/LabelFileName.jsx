  ...
  return (
    ...
    >
      <Grid>
        <AvniFormLabel
          label={"Label"}
          toolTipKey={"APP_DESIGNER_PRINT_LABEL"}
        />
        <Input
          id={label}
          value={label}
      ...
      <Grid>
        <AvniFormLabel
          label={"File Name"}
          toolTipKey={"APP_DESIGNER_PRINT_FILE_NAME"}
        />
        <Input
          id={fileName}
          value={fileName}
      ...
      <Grid>
        <div style={{ width: "300px" }}>
          ...
          <Select
            ...
            options={options}
            onChange={({ value }) =>
              dispatch({ type: "setScope", payload: { index, value } })
            }
          />
        </div>
      </Grid>
      <Grid>
        {index !== 0 && (
          <IconButton
            ...
            component="span"
            onClick={() =>
              dispatch({ type: "removeSetting", payload: { index } })
            }
            size="large"
          >
            <RemoveCircle />
