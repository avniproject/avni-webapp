...
export const UserMessagingConfig = () => {
  ...
  const [enableMessagingConfigSave, setEnableMessagingConfigSave] = useState(
    false
  );
  ...
  useEffect(() => {
    http.get("/organisationConfig").then(res => {
      ...
      const orgSettings = isEmpty(orgConfig)
        ? emptyOrgSettings
        : createOrgSettings(orgConfig[0]);
              ...
              <div className="container" style={{ float: "left" }}>
                {settings && settings.enableMessaging ? (
                  ...
                  <div>
                    ...
                    >
                      Enable Messaging for Organisation in-order to be able to
