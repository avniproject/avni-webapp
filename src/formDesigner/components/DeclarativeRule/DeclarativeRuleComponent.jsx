    ...
    >
      ...
      >
        <Button
          ...
          onClick={() =>
            dispatch({
              type: "deleteDeclarativeRule",
              payload: { declarativeRuleIndex }
            })
          }
      ...
      <IconButton
        ...
        onClick={() =>
          dispatch({ type: "newCondition", payload: { declarativeRuleIndex } })
        }
        disabled={
          !!find(declarativeRule.conditions, condition =>
            isEmpty(condition.conjunction)
          )
        }
        size="large"
      />
