...
public class EncounterSearchQueryBuilder {
    ...
    public EncounterSearchQueryBuilder withConceptsMap(Map<org.avni.domain.Concept, String> conceptsMap) {
        if (conceptsMap == null) return this;

        Set<Map.Entry<org.avni.domain.Concept, String>> entries = conceptsMap.entrySet();
