...
public class AvniReportRepository {
    ...
    public List<UserActivityResult> generateUserActivityResults() {
    ...
    public List<UserActivityResult> generateUserSyncFailures() {
        String baseQuery = "select coalesce(u.name, u.username) as name, \n" +
                ...
                "order by 2 desc\n" +
                "limit 10;";
        return jdbcTemplate.query(baseQuery, new UserCountMapper());
    }
    ...
    public List<AggregateReportResult> generateUserCancellingMostVisits() {
        String baseQuery = "with program_enc_data as (\n" +
                "    select last_modified_by_id,\n" +
