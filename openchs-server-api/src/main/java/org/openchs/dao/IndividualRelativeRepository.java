...
public interface IndividualRelativeRepository extends PagingAndSortingRepository<IndividualRelative, Long>, CHSRepository<IndividualRelative> {
    ...
    Page<IndividualRelative> findByAuditLastModifiedDateTimeGreaterThanOrderByAuditLastModifiedDateTimeAscIdAsc(@Param("lastModifiedDateTime") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) DateTime lastModifiedDateTime, Pageable pageable);
