...
--drop all views and materialized views dependent on p_schema_name.p_object_name and save DDL in deps_saved_ddl table
...
--recreate all the previously dropped objects
...
select deps_save_and_drop_dependencies('public', 'program_encounter');
ALTER table program_encounter
    ALTER COLUMN name TYPE varchar(255);
select deps_restore_dependencies('public', 'program_encounter');