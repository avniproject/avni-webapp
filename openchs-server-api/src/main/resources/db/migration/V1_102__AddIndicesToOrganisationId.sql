...
DROP INDEX IF EXISTS identifier_assignment_organisation_id__index;
CREATE INDEX identifier_assignment_organisation_id__index
  ON identifier_assignment (organisation_id);
DROP INDEX IF EXISTS identifier_source_organisation_id__index;
CREATE INDEX identifier_source_organisation_id__index
  ON identifier_source (organisation_id);
DROP INDEX IF EXISTS identifier_user_assignment_organisation_id__index;
CREATE INDEX identifier_user_assignment_organisation_id__index
  ON identifier_user_assignment (organisation_id);
DROP INDEX IF EXISTS sync_telemetry_organisation_id__index;
CREATE INDEX sync_telemetry_organisation_id__index
  ON sync_telemetry (organisation_id);
