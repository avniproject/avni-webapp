...
DECLARE
  exists BOOLEAN := FALSE;
BEGIN
  SELECT in_one_entity_coded_obs_contains($1, $2, 'School going', ARRAY ['Dropped Out']) INTO exists;
  RETURN exists;
END;
$$ LANGUAGE plpgsql;